...
- the current route state is the base for breadcrumb navigation work, which should remain legible and shareable across actors, workspaces, scopes, and selected messages
