...
- run a read-only reverse lookup for an ANVIL, GitHub, or Discord external item, see scope/message coordination summaries for each readable result, and jump directly into each linked NEXUS channel, post, thread, direct conversation, or message
