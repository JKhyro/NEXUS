...
- run a read-only reverse lookup for an ANVIL, GitHub, or Discord external item and jump directly into each readable linked NEXUS channel, post, thread, direct conversation, or message
